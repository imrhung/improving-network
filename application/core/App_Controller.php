...
class App_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->assets_css = array(
            ...
            'plugins/bootstrap-notify/bootstrap-notify.css',
            'sb-admin.css',
            'app.css'
            );
    ...
    private function set_styles()
    {
        ...
        //$this->template->append_metadata('<link href="//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">');
    ...
    /**
     * Renders plain page without navigation bar
     */
    public function render_plain_page($page, $data = array())
    {
        $this->assets_css[] = 'plain-page.css';
        // Renders the whole page
        $this->template
            ->set_metadata('keywords', $this->page_meta_keywords)
            ->set_metadata('description', $this->page_meta_description)
